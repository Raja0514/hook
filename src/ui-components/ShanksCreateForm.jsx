...
export default function ShanksCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setShankssize(initialValues.shankssize);
    setShanksused(initialValues.shanksused);
    setShanksdamage(initialValues.shanksdamage);
    setShankslost(initialValues.shankslost);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Shanks(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ShanksCreateForm")}
      {...rest}
    >
      <TextField
        label="Shankssize"
