...
export default function CouplingsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCouplingssize(initialValues.couplingssize);
    setCouplingsused(initialValues.couplingsused);
    setCouplingsdamage(initialValues.couplingsdamage);
    setCouplingslost(initialValues.couplingslost);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Couplings(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CouplingsCreateForm")}
      {...rest}
    >
      <TextField
        label="Couplingssize"
